...
int main() {
	...
	{
		cal(LU);
		time_+=(tail - head) * 1000 / freq;
	}
    time_/=T;
	time_base_=time_;
    cout << "平凡算法串行耗时：" << time_ << "ms" << endl;
    ...
    time_/=T;
    cout << "avx优化串行耗时： " << time_ << "ms" << endl;
	cout<<"加速比为: "<<(double)time_base_/time_<<endl; 
    ...
    time_/=T;
    cout << "平凡pthread耗时：" << time_ << "ms" << endl;
	cout<<"加速比为: "<<(double)time_base_/time_<<endl; 
    ...
    time_/=T;
    cout << "avx优化pthread耗时：" << time_ << "ms" << endl;
	cout<<"加速比为: "<<(double)time_base_/time_<<endl; 
    ...
    time_/=T;
    cout << "平凡算法静态8线程+信号量： " << time_ << "ms" << endl;
	cout<<"加速比为: "<<(double)time_base_/time_<<endl; 
    ...
    time_/=T;
    cout << "avx静态8线程+信号量： " << time_ << "ms" << endl;
	cout<<"加速比为: "<<(double)time_base_/time_<<endl; 
    ...
    time_/=T;
    cout << "平凡算法静态8线程+信号量三重循环： " << time_ << "ms" << endl;
	cout<<"加速比为: "<<(double)time_base_/time_<<endl; 
    ...
    time_/=T;
    cout << "avx静态8线程+信号量三重循环： " << time_ << "ms" << endl;
	cout<<"加速比为: "<<(double)time_base_/time_<<endl; 
    ...
    time_/=T;
    cout << "平凡算法静态barrier： " << time_ << "ms" << endl;
    cout<<"加速比为: "<<(double)time_base_/time_<<endl; 
    ...
    time_/=T;
    cout << "avx静态barrier：" << time_ << "ms" << endl;
    cout<<"加速比为: "<<(double)time_base_/time_<<endl; 
}
